...
@PlaceholderMeta(
    identifier = "bomberman",
    parent = PlaceholderManager.class
)
public class BombermanPositionPlaceholder implements PlaceholderModule {
    ...
    public String onRequest(EventMain eventMain, @Nullable OfflinePlayer offlinePlayer, List<String> args) {
        ...
        return infoForMinigamePosition(MinigameConstant.BOMBERMAN, position);
    }
}
