...
@PlaceholderMeta(
        identifier = "incursion",
        parent = PlaceholderManager.class
)
public class IncursionPositionPlaceholder implements PlaceholderModule {
    @Nullable
    @Override
    public String onRequest(EventMain eventMain, @Nullable OfflinePlayer offlinePlayer, List<String> args) {
        ...
        return infoForMinigamePosition(MinigameConstant.INCURSION, position);
    }
}
