...
public final class MinigameConstants {
    public static final String ENVOYS_DESC = "Collect as many envoys as possible!";
    ...
    public static final long PAINTBALL_DURATION = 180000L;
    public static final long BOATRACE_DURATION = 300000L;
}
