...
public class Cuboid {
    ...
    public Cuboid(final World world, final int xMin, final int yMin, final int zMin, final int xMax, final int yMax, final int zMax) {
    ...
    public Cuboid(final Location point1, final Location point2) {
        Preconditions.checkArgument(point1.getWorld() == point2.getWorld(), "Points must be in the same world");
